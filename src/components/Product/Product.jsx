            ...
            {product.nutrient_levels && (
              <>
                <li className="titlelist">
                  <span
                    className={`saturatedFat ${product.nutrient_levels['saturated-fat']}`}
                  ></span>
                  Graisse saturée
                </li>
                <li className="titlelist">
                  <span
                    className={`salt ${product.nutrient_levels.salt}`}
                  ></span>
                  Teneur en sel
                </li>
                <li className="titlelist">
                  <span
                    className={`sugars ${product.nutrient_levels.sugars}`}
                  ></span>
                  Teneur en sucre
                </li>
              </>
